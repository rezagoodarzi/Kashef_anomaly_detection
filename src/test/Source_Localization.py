...
class NeighborAnalyzer:
    ...
    def calculate_correlation_features(self, series1, series2):
        ...
        # Peak alignment
        peaks1, _ = find_peaks(series1, height=-108)
        peaks2, _ = find_peaks(series2, height=-108)
...
class Visualizer:
    ...
    def create_behavioral_connectivity(self, data_df, results):
        ...
        print(f"   Analyzing {min(5, len(sample_timestamps))} time periods...")
        
        for timestamp in sample_timestamps[:min(5, len(sample_timestamps))]:  # Limit to 100 time points
