...
df1 = pd.read_csv(r'C:\Users\USER\Desktop\kasheftest\Git_hub\Kashef_anomaly_detection\data\process\KJ3_ne_site_anomaly_coordinates.csv')
...
df2_filtered = df2[['Site', 'Latitude','Longitude',"TowerHeight", "AntennaHeight", "Azimuth", "MTilt", "ETilt"]].copy()
...
df1_filtered.to_csv("KJ_ne_site_anomaly_cordinate_degree.csv", index=False)
'''